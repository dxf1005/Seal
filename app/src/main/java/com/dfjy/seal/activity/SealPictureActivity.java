...
public class SealPictureActivity extends ListActivity {
...
//        getDataList.execute();
    ...
    public class GetDataList extends AsyncTask {
        ...
        protected void onPostExecute(Object o) {
            ...
            SimpleAdapter adapter = new SimpleAdapter(SealPictureActivity.this, getData(list),
        ...
        public List<FileInfoTable> getApplyListData() {
            ...
            urlStr.append("http://");
            urlStr.append(SPUtils.get(SealPictureActivity.this, "url", "").toString());
            urlStr.append("/SealServer/ServletFileInfo?flag=10");
            try {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_seal_picture, menu);
        return true;
    }
