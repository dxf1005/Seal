...
public class ApplyListActivity extends ListActivity {
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent.setClass(ApplyListActivity.this, ApplyDetailActivity.class);
    ...
    public class GetDataList extends AsyncTask {
        ...
        protected void onPostExecute(Object o) {
            ...
            SimpleAdapter adapter = new SimpleAdapter(ApplyListActivity.this, getData(list),
        ...
        public List<FileInfoTable> getApplyListData() {
            ...
            urlStr.append("http://");
            urlStr.append(SPUtils.get(ApplyListActivity.this,"url", "").toString());
            urlStr.append("/SealServer/ServletFileInfo?flag=0");
            urlStr.append("&writeid="+SPUtils.get(ApplyListActivity.this,"user", "").toString());
            try {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_apply_list, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_new_file) {
         Intent intent = new Intent(ApplyListActivity.this,ApplyNewFileActivity.class);
            startActivity(intent);
            return true;
        }
